...
Use the local SDK that is already bundled with the repo:

```powershell
.\.dotnet\dotnet.exe restore RustPlusDesk.sln
.\.dotnet\dotnet.exe test RustPlusDesk.sln --configuration Release
```
