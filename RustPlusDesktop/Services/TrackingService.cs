...
public static class TrackingService
{
    ...
    private static readonly string _fcmConfigPath = FcmConfigStore.PlainConfigPath;

    public static bool IsFcmConfigured()
        => FcmConfigStore.IsConfigured;
    ...
    public static void ReadFcmConfig()
    {
        try
        {
            var json = FcmConfigStore.ReadConfigJson();
    ...
    public static void PatchFcmConfigSteamId(string steamId)
    {
        try
        {
            ...
            FcmConfigStore.SaveConfigJson(updatedJson, keepPlaintext: File.Exists(_fcmConfigPath));
        }
        catch { }
    }
